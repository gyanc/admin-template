...
import { Users, UserCheck, FileText, HelpCircle, Mail, Settings, TrendingUp, Activity, Clock, ArrowUpRight, ArrowDownRight, Bell } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Generate mock data for charts (in production, this would come from analytics API)
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900">{stats.activeUsers}</p>
                </div>
              </div>
            </div>
          </div>
