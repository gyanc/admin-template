...
import { Loader2, Eye, EyeOff, Lock, Mail, ArrowRight, UserCheck } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-green-600 to-emerald-700 rounded-xl shadow-lg">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
          ...
          <div className="mt-6 p-4 bg-green-50 rounded-xl border border-green-200">
            ...
            <div className="space-y-1 text-xs text-gray-600">
              <p>
                <strong className="text-gray-700">Email:</strong> admin@adminpanel.com
              </p>
              <p>
