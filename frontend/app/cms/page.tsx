...
import { Plus, Search, Edit2, Trash2, MoreVertical, Loader2, Globe } from 'lucide-react';
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full">
                                    ...
                                    <tbody className="divide-y divide-gray-200">
                                        {pages.map((cmsPage) => (
                                            <tr key={cmsPage.id} className="hover:bg-gray-50 transition-colors">
                                                <td className="px-6 py-4">
                                                    <span className="font-medium text-gray-900">{cmsPage.title}</span>
                                                </td>
                                                <td className="px-6 py-4 text-gray-600 font-mono text-sm">/{cmsPage.slug}</td>
                                                <td className="px-6 py-4">
                                                    <span
                                                        className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-sm font-medium ${cmsPage.isPublished
                                                ...
                                                <td className="px-6 py-4 text-gray-600 text-sm">
                                                    {cmsPage.publishedAt
                                                        ? new Date(cmsPage.publishedAt).toLocaleDateString()
                                                        : '-'}
                                                </td>
